...
export const RESERVED_SUBDOMAINS = new Set([
  ...
  "internal", "localhost",
  // The owner's own products and sites, which have explicit DNS records
  // (Vercel / Netlify / Cloudflare Tunnel). An explicit record always beats
  // the wildcard, so a user claiming one of these would get a "live" link
  // that never loads their site — and could squat a real product's name.
  "agentfury", "fraudlens", "hireview", "poster-ai-engine", "prateek", "veecos", "voice",
]);
